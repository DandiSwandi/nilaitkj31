    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header row">
                <div class="h3 col-8">Data Santri</div>
                <div class="col-4">
                        ...
                        if (mysqli_num_rows($result)) {
                            ...
                            echo '<tr>
                                ...
                                <td>
                                    ...
                                    <a href="?m=santri&s=delete&id='.$r['ids'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Seriusan....?, Oowalahh..tapi kalo Menghapus jurusan akan menghilangkan semua data santri pada jurusan tersebut.\')"> Hapus</a>
                                </td>
                                </tr>';
                                $no++;
                        }
