    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header row">
                <div class="h3 col-8">Edit Jurusan</div>
                <div class="col-4">
                ...
                <form action="?m=santri&s=update" method="post">
                    <div class="mb-3">
                        <input type="text" name="nis" value="<?= $r['nis'] ?>" class="form-control"
                            placeholder="Nama Jurusan" required autofocus>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="radio" name="gender" value="perempuan" <?php
                    ...
                    <div class="mb-3">
                        <input type="text" name="pob" value="<?= $r['pob'] ?>" class="form-control"
                            placeholder="Tempat Lahir">
                    </div>
                    <div class="mb-3">
                        <input type="date" name="dob" value="<?= $r['dob'] ?>" class="form-control"
                    ...
                    <div class="mb-3">
                        <select name="major_id" class="form-control" required>
                            ...
                            $quary2 = mysqli_query($con, $sql2);
                            while ($r2 = mysqli_fetch_array($quary2)) {
                                ?>
                                <option value="<?= $r2['id'] ?>" <?= $r2['id'] == $r['major_id'] ? 'selected' : '' ?>>
                                    <?= $r2['name'] ?>
                                </option>
                            <?php } ?>
                        </select>
