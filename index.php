...
<head>
    ...
    <title>Aplikasi Nilai by Dandi Swandi</title>
    <link rel="shortcut icon" href="images/dg.jpg" type="image/x-icon"> 
    ...
    <div class="card">
        <div class="card-body">
            ...
            <span class="float-end">
                Versi 1.0 <a href="http://dandiswandi.rf.gd/?i=1" target="blank" rel="noopener noreferrer">Dandi Swandi</a>
            </span>
        </div>
    </div>
</div>
